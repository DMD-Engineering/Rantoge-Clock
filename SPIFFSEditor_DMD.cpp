...
const char *excludeListFile_DMD = "/.exclude.files";
...
static bool isExcluded(fs::FS &_fs, const char *filename) {
  if(excludes == NULL){
      loadExcludeList(_fs, excludeListFile_DMD);
  }
...
#ifdef ESP32
SPIFFSEditor_DMD::SPIFFSEditor_DMD(const fs::FS& fs, const String& username, const String& password)
#else
SPIFFSEditor_DMD::SPIFFSEditor_DMD(const String& username, const String& password, const fs::FS& fs)
#endif
:_fs(fs)
,_username(username)
,_password(password)
...
bool SPIFFSEditor_DMD::canHandle(AsyncWebServerRequest *request){
...
void SPIFFSEditor_DMD::handleRequest(AsyncWebServerRequest *request){
...
void SPIFFSEditor_DMD::handleUpload(AsyncWebServerRequest *request, const String& filename, size_t index, uint8_t *data, size_t len, bool final){
  if(!index){
